...
<body style="height:100%">
	...
	res('etreecell',
	'Creates a Etreecell canvas object on which to draw. <Br />You must do this first',
				array(	'*DOM element' => 'object/',
	...
	res('Style',
	'Style Array',
				array(	'stroke' => 'hex/Color of stroke',
				...
				array(	'link' , 'object', 'Return created link.'),
...
','object');
	...
	res('etreecell.resize',
	'Resize a etreecell Canvas.',
				array(	'width || document.width' => 'int/Resize the width of etrecell canvas.', 
...
etcl.resize(100,500);');
	...
	res('etreecell.createCell',
	'Creates a Cell in etreecell Canvas.',
				array(	'*id' => 'string/Id of create cell.', 
				'style' => 'array/Style and attribution of create cell.'),
				array(	'cell' , 'object', 'Return created cell.'),
				'var cell1 = etcl.createCell("cell1");
	
// Create cell include style.
var cell2 = etcl.createCell("cell2", { stroke : "#eeeee", stroke-width : 3 });');

	res('etreecell.createLink',
	'Creates a Link in etreecell Canvas.',
				array(	'*outCell' => 'object/A Cell of link A to B.',
...
');
	...
	res('etreecell.removeCell',
	'Remove a Cell in etreecell Canvas.',
				array(	'*cell' => 'object/Cell object for remove.'),
				null,
				'var cell1 = etcl.createCell("cell1");
...
etcl.removeCell(cell1);');
	...
	res('etreecell.removeLink',
	'Remove a Link in etreecell Canvas.',
				array(	'*link' => 'object/Link object for remove.'),
				null,
				'var link1 = etcl.createLink("cell1", "cell2");
	
// Remove link1.
etcl.removeLink(link1);');


	res('etreecell.selectCell',
	'Select cell(s) object in etreecell Canvas.',
				array(	'*cells' => 'object/cell object(s) for select.',
...
etcl.selectCell(cell3, true);');
	...
	res('etreecell.deselectCell',
	'Deselect cell(s) object in etreecell Canvas.',
				array(	'*cells' => 'object/cell object(s) for deselect.'
				),
				null,
				'var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
etcl.deselectCell( [cell2, cell3] );');
	...
	res('etreecell.deselectAllCell',
	'Deselect all cells in etreecell Canvas.',
				array(),
				null,
				'var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
etcl.deselectAllCell();');
	...
	res('etreecell.selectLink',
	'Select link(s) object in etreecell Canvas.',
				array(	'*links' => 'object/link object(s) for select.',
...
etcl.selectLink(link1_2, true);');
	...
	res('etreecell.deselectLink',
	'Deselect link(s) object in etreecell Canvas.',
				array(	'*links' => 'object/link object(s) for deselect.'
				),
				null,
				'var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
etcl.deselectCell( [link1_2, link2_3] );');
	...
	res('etreecell.deselectAllLink',
	'Deselect all links in etreecell Canvas.',
				array(),
				null,
				'var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
etcl.deselectAllLink();');
	...
	res('etreecell.deselectAll',
	'Deselect all cells and links in etreecell Canvas.',
				array(),
				null,
				'var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
etcl.deselectAll();');
	...
	res('etreecell.changeAttrCell',
	'Change the style of cell in etreecell Canvas.',
				array(
...
etcl.changeAttrCell(cell1, { fill : "red", opaciy : .5 });');
	...
	res('etreecell.changeAnimateCell',
	'Change the style of cell in etreecell Canvas.',
				array(
					'*cell' => 'object/Cell Object for change the style.',
					'*style' => 'array/Style(attr) for change the style.',
...
etcl.changeAnimateCell(cell1, { 
	...
	res('etreecell.bindStyleCell',
	'Binding Style of cell in etreecell Canvas.(for CELL SDK)',
				array(
...
etcl.bindStyleCell(cell1, text1, ["x", "width"]);');
	...
	res('etreecell.unbindStyleCell',
	'Ring off binding Style of cell in etreecell Canvas.(for CELL SDK)',
				array(
...
etcl.bindStyleCell(cell1, text1);');
	...
	res('etreecell.setDataCell',
	'Set the data of cell in etreecell Canvas.',
				array(	'*cell' => 'object/Cell object for set the data.',
...
etcl.setDataCell(cell1, 1, 35035);');
	...
	res('etreecell.onLinked',
	'Excute function when linked in etreecell Canvas.',
				array(	'*function' => 'function/Object of link.'
				),
				array(	'function' , 'function', 'Return to value of parameter\'s function.'),
'// Create Cell for link.
var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2", { stroke : "#eeeee", stroke-width : 3 });
...
');
	...
	res('Cell.link',
	'Link cell of parameter.',
				array(	'*cell' => 'object/Object of cell.'
				),
				array(	'link' , 'object', 'Return Link or Boolean false when link is fail.'),
'// Create Cell for link.
var cell1 = etcl.createCell("cell1");
var cell2 = etcl.createCell("cell2");
...
');
	...
	?>
<div style="position:fixed;float: left; width:250px; height: 100%; background:#222c33; color:#e0e0e0">
	<br />
	<br />
<?php
